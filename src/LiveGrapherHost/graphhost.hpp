...
public:
    ...
    int graphData(uint64_t x, float y, std::string dataset);
...
int sockets_sendlist(struct list_t *list, struct list_elem_t *elem);

int sockets_writeh(struct list_t *list, struct list_elem_t *elem);
